...
namespace FredBradley\NhsNumber\Tests;

use FredBradley\NhsNumber\Generator;
...
class ExampleTest extends TestCase
{
    ...
    /** @test */
    public function it_will_return_true_for_valid_nhs_number()
    {
        $testVar = Generator::nhsNumber();
        $nhsNumber = new NhsNumber($testVar);
        $this->assertTrue($nhsNumber->isValid());
    }
